        ...
        <div>
            ...
            <div>
                <div className="card" style={{width: "18rem"}}>
                 ...
                 <div className="card" style={{width: "18rem"}}>
                    <img src="./All_images/cooking.webp" className="card-img-top" alt="Programming-image" /> 
                    <div className="card-body">
                        <h5 className="card-title">Cooking </h5>   
                    </div>
                </div>
                 <div className="card" style={{width: "18rem"}}>
                    <img src="./All_images/workout.jpg" className="card-img-top" alt="Programming-image" /> 
                    <div className="card-body">
